		...
		<div class="column small-12 medium-6 slider--wrapper">
			<div id="js--top-slider" class="slick-slider">
				...
				<article class="slick-slide slide--item card">
					<div class="card--img">
						<img src="<?php echo $img; ?>" alt="<?php the_title(); ?>" width="<?php echo $width; ?>"
		...
		<div class="column small-12 medium-6 copy--top text-center">
			...
			<div class="copy--desc">
				<p>相談件数17,000件以上。
					...
					<strong style="background:yellow;color:red">初回相談無料</strong></p>
			...
			<p class="topheader--button">
				<a href="https://www.law-yamashita.com/contact" class="button hollow expanded" title="メールで相談予約"
					target="_blank">
			...
			<p class="topheader--button">
				<a href="https://www.law-yamashita.com" target="_blank" class="button hollow expanded"
					title="メインサイトを見る">
