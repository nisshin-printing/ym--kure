		...
		<div class="column small-12 large-8 contents --mt0 --pt0">
			...
			<section class="contents--section contents--section__images">
				<div class="row align-middle">
					...
					<div class="column small-12 medium-6">
						<img class="thumbnail"
							...
							alt="山下江法律事務所呉支部はクラウドを活用することで豊富な経験・多数の解決事例を共有し、どこの事務所でも同一のサ―ビスを提供できます。">
					</div>
					<div class="column small-12 medium-6">
				...
				<div class="row align-middle">
					...
					<div class="column small-12 medium-6">
						<img class="thumbnail"
							...
							alt="山下江法律事務所呉支部もプライバシーポリシーや行動指針に基づいた「気軽に相談できる場」を創造しました。">
					</div>
					<div class="column small-12 medium-6">
						<p>新しくオープンした呉支部でも、山下江法律事務所の<a href="<?php echo get_the_permalink('360'); ?>"
				...
				<div class="row align-middle">
					...
					<div class="column small-12 medium-6">
						<img class="thumbnail"
							src="//www.law-yamashita.com/wp-content/themes/ym-home/assets/img/lp/kure/3.jpg"
							alt="山下江法律事務所呉支部では居心地の良い空間を演出しています。">
					</div>
					<div class="column small-12 medium-6">
				...
				<div class="row">
					<div class="column">
						<p class="text-center"><img
								src="//www.law-yamashita.com/wp-content/themes/ym-home/assets/img/access/map--kure.png"
								alt="山下江法律事務所呉支部までのアクセス方法"></p>
						<p class="text-center"><a class="button link-external" href="https://goo.gl/maps/tH6MMvP8YtQ2"
								title="Googleマップで見る" target="_blank" rel="nofollow">Googleマップで見る</a>　<a
								href="https://www.law-yamashita.com/downloads/access/print--kure.pdf"
								class="button">印刷用PDF</a></p>
						<p>〒737-0051　広島県呉市中央２丁目５－２ NSビル７０３<br>TEL： 0823-25-0077　FAX： 0823-25-0081<br>営業時間：　平日9：00～18：00
						</p>
					</div>
				</div>
			</section>
...
=======
					<dt><span
							class="label secondary"><?php the_modified_date( 'Y-m-d' ); ?></span>　<?php the_category( '　' ); ?>
					</dt>
>>>>>>> 25ecf8871dccc070a8cd8eec39b690a343e40905
